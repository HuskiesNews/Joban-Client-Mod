...
public class JoestuClient {
	...
	public static void init() {
		...
		RegistryClient.registerTileEntityRenderer(BlockEntityTypes.PIDS_4_TILE_ENTITY, dispatcher -> new RenderLCDPIDS<>(dispatcher, PIDS4.TileEntityBlockPIDS4.MAX_ARRIVALS, 5.7F, 9.5F, 6, 11.5F, 21, true, false, false, 0xEFE29E, 0xEFE29E, 1.25F, false, false, ClientConfig.getPIDS4ChinFont(), ClientConfig.getPIDS4ChinFont()));
