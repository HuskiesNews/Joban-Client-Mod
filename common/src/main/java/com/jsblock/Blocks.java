...
public interface Blocks {
	...
	Block SOUND_LOOPER = new SoundLooper(BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.SMOOTH_SANDSTONE));
	...
	Block EXIT_SIGN_1O = new ExitSign1o(BlockBehaviour.Properties.of(Material.METAL).strength(1.5f).lightLevel(state -> 10));
	Block EXIT_SIGN_1E = new ExitSign1e(BlockBehaviour.Properties.of(Material.METAL).strength(1.5f).lightLevel(state -> 10));
	...
	Block HELPLINE_3 = new HelpLine3(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).noOcclusion());
	Block HELPLINE_4 = new HelpLine4(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).noOcclusion());
	Block HELPLINE_5 = new HelpLine5(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).lightLevel(state -> 15).noOcclusion());
	Block KCR_NAME_SIGN = new KCRNameSign(BlockBehaviour.Properties.of(Material.METAL).strength(5.0f).lightLevel(state -> 15).noOcclusion());
	Block KCR_EMG_STOP_SIGN = new KCREmgStopSign(BlockBehaviour.Properties.of(Material.METAL).strength(3.0f).noOcclusion());
	Block LIGHT_1 = new Light1(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).lightLevel(state -> 15));
	Block LIGHT_2 = new Light2(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f).lightLevel(state -> 15));
	Block LIGHT_BLOCK = new LightBlock(BlockBehaviour.Properties.of(Material.METAL).strength(1.0f).lightLevel(state -> 15).noOcclusion());
	Block OP_BUTTONS = new OpOnlyButton(BlockBehaviour.Properties.of(Material.METAL).strength(1.0f).lightLevel(state -> 15).noOcclusion());
	...
	Block RV_PIDS_POLE = new RVPIDSPole(BlockBehaviour.Properties.of(Material.METAL).strength(1.0f).noOcclusion());
	...
	Block TRESPASS_SIGN_1 = new TrespassSign1(BlockBehaviour.Properties.of(Material.METAL).strength(1.5f).noOcclusion());
