...
public interface BlockEntityTypes {
	...
	BlockEntityType<PIDSRVTCL.TileEntityBlockPIDS5> PIDS_5_TILE_ENTITY = RegistryUtilities.getBlockEntityType(PIDSRVTCL.TileEntityBlockPIDS5::new, Blocks.PIDS_RV);
